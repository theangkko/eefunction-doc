...
Shared Folder: [O365 OneDrive](https://1drv.ms/f/s!AjtDw6AXQrGwhQcErmClmFVoxmPh?e=ORakqb)
...
eeFunction에 제공하는 Web Assembly 기반의 몇 개 함수가
브라우저에서는 동작하지만 Desktop에서는 동작하지 않습니다.

따라서, 현재는 Desktop Module은 별도 제공하지 않습니다.
