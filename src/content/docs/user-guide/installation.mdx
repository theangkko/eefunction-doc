...
- Add from MS Marketplace
- Search and add from Excel Add-ins


### Using Microsoft Marketplace

- Go to the MS Marketplace URL address.  <a href="https://marketplace.microsoft.com/en-us/product/office/WA200007295?tab=Overview" target="_blank"> LINK </a>
...
![Web-Excel](../../../assets/eefunction/Screenshot_appsource_url02_260316.png)
