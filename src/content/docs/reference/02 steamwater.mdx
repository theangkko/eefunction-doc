...
description: Steam and water property functions based on IF97 Steam Table.
---

IF97 Steam Table uses the following code
- <a href="https://github.com/kpatvt/xsteam2" target="_blank" rel="noopener noreferrer">xsteam2</a> by kpatvt

Items calculated in Javascript use the xsteam2 module.

**Steam function UNIT**

import TableSteamWater from './TableSteamWater.astro';
